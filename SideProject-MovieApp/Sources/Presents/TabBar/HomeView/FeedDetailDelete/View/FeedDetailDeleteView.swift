...
final class FeedDetailDeleteView: BaseView {
    let alertView: AlertButtonSecondView = {
        let view = AlertButtonSecondView(title: "리뷰 삭제", subtitle: "정말 삭제하시겠습니까?", okButtonTitle: "아니요", cancelButtonTitle: "삭제")
        return view
    }()
