...
final class FeedDetailHideUserAlertViewController: BaseViewController {
    ...
    override func setupBinding() {
        let input = FeedDetailHideUserAlertViewModel.Input(okButtonTapped: self.selfView.alertView.okButton.rx.tap, cancelButtonTapped: self.selfView.alertView.cancelButton.rx.tap)
