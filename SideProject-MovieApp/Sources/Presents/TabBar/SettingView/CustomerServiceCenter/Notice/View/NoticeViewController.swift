...
final class NoticeViewController: BaseViewController {
    ...
    private func configureDataSource() {
        let cellRegistration = UICollectionView.CellRegistration<ExpandableListCell, Item> { (cell, indexPath, itemIdentifier) in
            cell.configure(ExpandableListCellViewModel(title: itemIdentifier.title,
                                                       subTitle: itemIdentifier.subTitle,
                                                       message: itemIdentifier.noticeMessage,
                                                       isExpanded: itemIdentifier.isExpanded))
        }
