...
struct Font {
    static let title1 = UIFont(name: SuitFont.Bold.rawValue, size: 24)
    static let title2 = UIFont(name: SuitFont.Bold.rawValue, size: 20)
    static let title3 = UIFont(name: SuitFont.Bold.rawValue, size: 16)
    
    static let subtitle1 = UIFont(name: SuitFont.SemiBold.rawValue, size: 20)
    static let subtitle2 = UIFont(name: SuitFont.SemiBold.rawValue, size: 16)
