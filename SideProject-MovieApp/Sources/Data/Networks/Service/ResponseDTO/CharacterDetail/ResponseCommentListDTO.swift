...
extension ResponseCommentListDTO {
    var toDomain: CommentList {
        .init(comment_id: comment_id, review_id: review_id, user_id: user_id, comment_like: comment_like, comment_content: comment_content, comment_spoiler: comment_spoiler, character_id: character_id)
    }
}
